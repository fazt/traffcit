...
const Weather = () => {
  return (
    <div className="col-sm-3">
      <div id="card" className="dash-unit">
          ...
          <article>
            ...
            <div className="icon">
              <svg version="1.1" id="icon" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                 viewBox="0 0 59.077 59.077" style={{'enableBackground':'new 0 0 59.077 59.077'}} xmlSpace="preserve">
              <g>
        ...
        <div className="row">
          <div className="col-md-12">
            <button className="btn btn-primary btn-block">hello</button>
          </div>
